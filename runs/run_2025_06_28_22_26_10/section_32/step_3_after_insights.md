...
Fu Yu Corporation Limited (Fu Yu) presents a complex financial narrative marked by a significant strategic pivot amidst underlying challenges. The group's **overall revenue** increased marginally by 0.5% to S$191.3 million in FY2024 (FY2023: S$190.4 million) (Table B.1.1). However, this modest headline growth **masks a critical strategic shift**: the discontinuation of the Supply Chain Management Services (SCS) segment. While the decision to discontinue was made in Q4 2024, the SCS segment remained operational throughout the fiscal year, contributing S$76.4 million to FY2024 revenue (down from S$86.4 million in FY2023) and accounting for a loss of S$2.672 million (FY2024) and S$2.513 million (FY2023) to the total net loss (Table C.15.1, C.21.1, B.1.1).

**What does this discontinuation signify?** It is not merely a strategic pivot but a **critical corrective action** stemming from significant past failures and governance lapses within the SCS segment. The ongoing investigation into FYSCS's past affairs, highlighted by a **qualified audit opinion** and management's inability to fully assure internal controls for this segment, strongly supports this decision (Source: Fu Yu 24 AR, Page 104, 99). The audit report explicitly noted "significant weaknesses" in FYSCS's risk management process, including potential "unverifiable arrangements" and "unauthorized usage." This suggests a systemic breakdown in oversight rather than a mere strategic re-evaluation. While necessary, this divestment implies a **material cost of rectifying prior issues**, including potential financial liabilities or legal fallout, which are not explicitly detailed but remain a critical investor concern.
