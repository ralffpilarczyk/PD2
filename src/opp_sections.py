...
sections = [
    {
        ...
        "specs": "Provide a comprehensive overview of the company's business.\\n"
                ...
                "• One sentence on key customers and how the company sells and contracts with them, e.g. long term contracts, exclusivity, etc.\\n"
    ...
    },
    {
        ...
        "specs": "Summarise key strategic considerations for the company as an investment or acquisition target.\\n"
                ...
                "• One sentence on the key decision makers at the shareholder level and their strategic agenda in general, their objectives towards the company, any indications of their willingness to sell, or if they have any relevant track record in the sector\\n"
