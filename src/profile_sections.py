...
sections = [
    ...
    },
    {
        ...
        "specs": "Summarise the company's M&A agenda as follows:\\n"
                ...
                "3. Statements towards acquisitions, divestitures, monetisations or restructurings - including management commentary on appetite and priorities\\n"
                "4. Specific deals currently underway and transaction status - active discussions, LOIs, due diligence, regulatory approvals, or recently completed/failed deals\\n"
                "5. M&A capacity and constraints - financial capacity, leverage limits, regulatory considerations\\n"
                "6. Track record - historical M&A performance and integration outcomes where disclosed\\n"
                "7. Recent corporate events - extract and analyze significant corporate events and transactions over the last 2 years.\\n"
